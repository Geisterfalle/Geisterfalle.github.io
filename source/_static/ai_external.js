...
if (typeof iframe_id === 'undefined') {
    var iframe_id_advanced_iframe123456 = 'advanced_iframe123456';
}  else {
/* jshint ignore:start */
    iframe_id_advanced_iframe123456 = iframe_id;
/* jshint ignore:end */
}
...
window.jQuery || document.write('<script src="http://ehrbase.org/wp-includes/js/jquery/jquery.js"></script>');
 ...
 */ 
function aiExecuteWorkaround_advanced_iframe123456() {
    if (window!==window.top) { /* I'm in a frame! */ 

      if (updateIframeHeight === 'true') { 
        // add the iframe dynamically
        var url = domain_advanced_iframe123456+'/js/iframe_height.html';
        var empty_url = 'about:blank';
        var newElementStr = '<iframe id="ai_hidden_iframe_advanced_iframe123456" style="display:none;clear:both" width="0" height="0" src="';
        ...
        var iframe = document.getElementById('ai_hidden_iframe_advanced_iframe123456');
        // 4 pixels extra are needed because of IE! (2 for Chrome)
        // If you still have scrollbars add a little bit more offset.
        var url_str = url + '?height=' + (newHeight + 4) + '&width=' + iframeWidth + '&id=' + iframe_id_advanced_iframe123456; 
        iframe.src = url_str; 
        ...
        // add the iframe dynamically
        var urlShow = domain_advanced_iframe123456 + '/js/iframe_show.html?id='+ iframe_id_advanced_iframe123456;
        var newElementStrShow = '<iframe id="ai_hidden_iframe_show_advanced_iframe123456" style="display:none;" width="0" height="0" src="';
...
addOnloadEvent(aiExecuteWorkaround_advanced_iframe123456);